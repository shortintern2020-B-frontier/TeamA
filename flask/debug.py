...
def upload():
    ...
    if request.method == 'POST':
        ...
        response = s3.Bucket('rakuten.intern2020').put_object(Key="img/"+"file_name", Body=uploaded_file,ContentType="image/jpeg")
        ...
        ##mealが5個ある前提
        file_name="file_name"
        meal_name1 = payload.get('meal_name1')
        meal_name2 = payload.get('meal_name2')
        meal_name3 = payload.get('meal_name3')
        meal_name4 = payload.get('meal_name4')
        meal_name5 = payload.get('meal_name5')
        recipe_url = payload.get('recipe_url')
        post_comment = payload.get('post_comment')
        print(post_comment,"postcomment")
        print(meal_name5)
        ...
        point1 = Meal_content.query.filter(Meal_content.name==meal_name1).all()[0].point
        ...
        meal_id1=Meal_content.query.filter(Meal_content.name==meal_name1).all()[0].meal_id
